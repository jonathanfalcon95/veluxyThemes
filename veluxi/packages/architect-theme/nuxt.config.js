...
module.exports = {
  ...
  */
  head: {
    ...
    title: brand.architect.name,
    meta: [
      { charset: 'utf-8' },
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      { name: 'description', content: brand.architect.desc },
      ...
      { property: 'og:url', content: brand.architect.url },
      { property: 'og:title', content: brand.architect.projectName },
      { property: 'og:description', content: brand.architect.desc },
      { name: 'twitter:site', content: brand.architect.url },
      { name: 'twitter:card', content: 'summary_large_image' },
      { name: 'twitter:image', content: brand.architect.img },
      { property: 'og:image', content: brand.architect.img },
