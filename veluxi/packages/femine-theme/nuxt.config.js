...
module.exports = {
  ...
  */
  head: {
    ...
    title: brand.femine.name,
    meta: [
      { charset: 'utf-8' },
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      { name: 'description', content: brand.femine.desc },
      ...
      { property: 'og:url', content: brand.femine.url },
      { property: 'og:title', content: brand.femine.projectName },
      { property: 'og:description', content: brand.femine.desc },
      { name: 'twitter:site', content: brand.femine.url },
      { name: 'twitter:card', content: 'summary_large_image' },
      { name: 'twitter:image', content: brand.femine.img },
      { property: 'og:image', content: brand.femine.img },
