...
module.exports = {
  ...
  */
  head: {
    ...
    title: brand.maskulino.name,
    meta: [
      { charset: 'utf-8' },
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      { name: 'description', content: brand.maskulino.desc },
      ...
      { property: 'og:url', content: brand.maskulino.url },
      { property: 'og:title', content: brand.maskulino.projectName },
      { property: 'og:description', content: brand.maskulino.desc },
      { name: 'twitter:site', content: brand.maskulino.url },
      { name: 'twitter:card', content: 'summary_large_image' },
      { name: 'twitter:image', content: brand.maskulino.img },
      { property: 'og:image', content: brand.maskulino.img },
