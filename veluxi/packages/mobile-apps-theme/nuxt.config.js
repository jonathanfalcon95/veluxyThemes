  ...
  */
  head: {
    ...
    meta: [
      ...
      { name: 'description', content: brand.mobile.desc },
      ...
      { property: 'og:url', content: brand.mobile.url },
      { property: 'og:title', content: brand.mobile.projectName },
      { property: 'og:description', content: brand.mobile.desc },
      { name: 'twitter:site', content: brand.mobile.url },
      { name: 'twitter:card', content: 'summary_large_image' },
      { name: 'twitter:image', content: brand.mobile.img },
      { property: 'og:image', content: brand.mobile.img },
