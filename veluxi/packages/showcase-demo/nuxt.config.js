...
module.exports = {
  ...
  */
  head: {
    ...
    title: 'Veluxi - Vue Single Landing Page Template Collection',
    meta: [
      { charset: 'utf-8' },
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      { name: 'description', content: brand.showcase.desc },
      ...
      // Twitter
      { property: 'twitter:site', content: 'veluxi.ux-maestro.com' },
      { property: 'twitter:domain', content: 'veluxi.ux-maestro.com' },
      { property: 'twitter:creator', content: 'veluxi' },
      { property: 'twitter:card', content: 'summary' },
      { property: 'twitter:image:src', content: '/images/logo.png' },
      { property: 'og:url', content: brand.showcase.url },
      { property: 'og:title', content: brand.showcase.projectName },
      { property: 'og:description', content: brand.showcase.desc },
      { name: 'twitter:site', content: brand.showcase.url },
      { name: 'twitter:card', content: 'summary_large_image' },
      { name: 'twitter:image', content: brand.showcase.img },
      { property: 'og:image', content: brand.showcase.img },
