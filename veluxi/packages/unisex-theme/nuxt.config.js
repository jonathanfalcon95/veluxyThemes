...
module.exports = {
  ...
  */
  head: {
    ...
    title: brand.unisex.name,
    meta: [
      { charset: 'utf-8' },
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      { name: 'description', content: brand.unisex.desc },
      ...
      { property: 'og:url', content: brand.unisex.url },
      { property: 'og:title', content: brand.unisex.projectName },
      { property: 'og:description', content: brand.unisex.desc },
      { name: 'twitter:site', content: brand.unisex.url },
      { name: 'twitter:card', content: 'summary_large_image' },
      { name: 'twitter:image', content: brand.unisex.img },
      { property: 'og:image', content: brand.unisex.img },
